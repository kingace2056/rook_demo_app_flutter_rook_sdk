...
mixin _$HeartRate {
  ...
  int? get hrvAvgRmssdFloat => throw _privateConstructorUsedError;
  @JsonKey(name: 'hrv_avg_sdnn_float')
  int? get hrvAvgSdnnFloat => throw _privateConstructorUsedError;
  @JsonKey(name: 'hr_granular_data_array')
  List<HrGranularDataArray>? get hrGranularDataArray =>
...
class _$HeartRateImpl implements _HeartRate {
  _$HeartRateImpl(
      ...
      @JsonKey(name: 'hr_granular_data_array')
      final List<HrGranularDataArray>? hrGranularDataArray})
  ...
  @override
  @JsonKey(name: 'hrv_avg_rmssd_float')
  final int? hrvAvgRmssdFloat;
  @override
  @JsonKey(name: 'hrv_avg_sdnn_float')
  final int? hrvAvgSdnnFloat;
  final List<HrGranularDataArray>? _hrGranularDataArray;
  @override
  @JsonKey(name: 'hr_granular_data_array')
  List<HrGranularDataArray>? get hrGranularDataArray {
  ...
  @override
  String toString() {
    return 'HeartRate(hrMaximumBpmInt: $hrMaximumBpmInt, hrMinimumBpmInt: $hrMinimumBpmInt, hrAvgBpmInt: $hrAvgBpmInt, hrRestingBpmInt: $hrRestingBpmInt, hrvAvgRmssdFloat: $hrvAvgRmssdFloat, hrvAvgSdnnFloat: $hrvAvgSdnnFloat, hrGranularDataArray: $hrGranularDataArray)';
  }
...
abstract class _HeartRate implements HeartRate {
  factory _HeartRate(
      ...
      @JsonKey(name: 'hrv_avg_rmssd_float') final int? hrvAvgRmssdFloat,
      @JsonKey(name: 'hrv_avg_sdnn_float') final int? hrvAvgSdnnFloat,
      @JsonKey(name: 'hr_granular_data_array')
      final List<HrGranularDataArray>? hrGranularDataArray}) = _$HeartRateImpl;
  ...
  @override
  @JsonKey(name: 'hrv_avg_rmssd_float')
  int? get hrvAvgRmssdFloat;
  @override
  @JsonKey(name: 'hrv_avg_sdnn_float')
  int? get hrvAvgSdnnFloat;
  @override
  @JsonKey(name: 'hr_granular_data_array')
  List<HrGranularDataArray>? get hrGranularDataArray;
