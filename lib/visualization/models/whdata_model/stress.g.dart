...
_$StressImpl _$$StressImplFromJson(Map<String, dynamic> json) => _$StressImpl(
      ...
      stressDurationSecondsInt:
          (json['stress_duration_seconds_int'] as num?)?.toInt(),
      lowStressDurationSecondsInt:
          (json['low_stress_duration_seconds_int'] as num?)?.toInt(),
      ...
      stressMaximumLevelInt:
          (json['stress_maximum_level_int'] as num?)?.toInt(),
    );
...
Map<String, dynamic> _$$StressImplToJson(_$StressImpl instance) =>
    <String, dynamic>{
      ...
      'medium_stress_duration_seconds_int':
          instance.mediumStressDurationSecondsInt,
