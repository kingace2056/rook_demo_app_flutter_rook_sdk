...
_$DistanceImpl _$$DistanceImplFromJson(
  Map<String, dynamic> json,
) => _$DistanceImpl(
  stepsInt: (json['steps_int'] as num?)?.toInt(),
  walkedDistanceMetersFloat: (json['walked_distance_meters_float'] as num?)
      ?.toInt(),
  traveledDistanceMetersFloat: (json['traveled_distance_meters_float'] as num?)
      ?.toInt(),
  ...
  elevationLossActualAltitudeMetersFloat:
      (json['elevation_loss_actual_altitude_meters_float'] as num?)?.toDouble(),
  elevationGainActualAltitudeMetersFloat:
      (json['elevation_gain_actual_altitude_meters_float'] as num?)?.toDouble(),
  elevationPlannedGainMetersFloat:
      (json['elevation_planned_gain_meters_float'] as num?)?.toDouble(),
  swimmingNumStrokesFloat: (json['swimming_num_strokes_float'] as num?)
      ?.toDouble(),
  ...
  activeStepsGranularDataArray:
      (json['activeStepsGranularDataArray'] as List<dynamic>?)
          ?.map(
            (e) => ActiveStepsGranularDataArray.fromJson(
...
Map<String, dynamic> _$$DistanceImplToJson(
  _$DistanceImpl instance,
) => <String, dynamic>{
  ...
  'swimming_pool_length_meters_float': instance.swimmingPoolLengthMetersFloat,
