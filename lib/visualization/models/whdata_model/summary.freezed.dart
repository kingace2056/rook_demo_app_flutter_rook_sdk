...
/// @nodoc
mixin _$Summary {
  @JsonKey(name: 'physical_summary')
  PhysicalSummary? get physicalSummary => throw _privateConstructorUsedError;
...
abstract class $SummaryCopyWith<$Res> {
  ...
  $PhysicalSummaryCopyWith<$Res>? get physicalSummary;
...
class _$SummaryCopyWithImpl<$Res, $Val extends Summary>
  ...
  @override
  $Res call({
    Object? physicalSummary = freezed,
    Object? sleepSummary = freezed,
  }) {
    return _then(
      _value.copyWith(
            physicalSummary: freezed == physicalSummary
                ? _value.physicalSummary
                : physicalSummary // ignore: cast_nullable_to_non_nullable
                      as PhysicalSummary?,
  ...
  @pragma('vm:prefer-inline')
  $PhysicalSummaryCopyWith<$Res>? get physicalSummary {
    if (_value.physicalSummary == null) {
      return null;
    }

    return $PhysicalSummaryCopyWith<$Res>(_value.physicalSummary!, (value) {
      return _then(_value.copyWith(physicalSummary: value) as $Val);
    });
  }
...
class _$SummaryImpl implements _Summary {
  _$SummaryImpl({
    @JsonKey(name: 'physical_summary') this.physicalSummary,
    @JsonKey(name: 'sleep_summary') this.sleepSummary,
  });
  ...
  @override
  @JsonKey(name: 'physical_summary')
  final PhysicalSummary? physicalSummary;
  @override
  @JsonKey(name: 'sleep_summary')
  ...
  @override
  String toString() {
    return 'Summary(physicalSummary: $physicalSummary, sleepSummary: $sleepSummary)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.physicalSummary, physicalSummary) ||
                other.physicalSummary == physicalSummary) &&
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, physicalSummary, sleepSummary);
...
abstract class _Summary implements Summary {
  factory _Summary({
    @JsonKey(name: 'physical_summary') final PhysicalSummary? physicalSummary,
  ...
  @override
  @JsonKey(name: 'physical_summary')
  PhysicalSummary? get physicalSummary;
  @override
  @JsonKey(name: 'sleep_summary')
