...
_$BodyMetricsImpl _$$BodyMetricsImplFromJson(Map<String, dynamic> json) =>
    _$BodyMetricsImpl(
      waistCircumferenceCmInt:
          (json['waist_circumference_cm_int'] as num?)?.toInt(),
      hipCircumferenceCmInt:
          (json['hip_circumference_cm_int'] as num?)?.toInt(),
      chestCircumferenceCmInt:
          (json['chest_circumference_cm_int'] as num?)?.toInt(),
...
Map<String, dynamic> _$$BodyMetricsImplToJson(_$BodyMetricsImpl instance) =>
    <String, dynamic>{
      ...
      'muscle_composition_percentage_int':
          instance.muscleCompositionPercentageInt,
      'water_composition_percentage_int':
          instance.waterCompositionPercentageInt,
