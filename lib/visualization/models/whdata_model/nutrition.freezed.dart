...
/// @nodoc
mixin _$Nutrition {
  @JsonKey(name: 'food_intake_float')
  double? get foodIntakeFloat => throw _privateConstructorUsedError;
  @JsonKey(name: 'calories_intake_kcal_float')
  double? get caloriesIntakeKcalFloat => throw _privateConstructorUsedError;
  @JsonKey(name: 'protein_intake_g_float')
  double? get proteinIntakeGFloat => throw _privateConstructorUsedError;
  @JsonKey(name: 'sugar_intake_g_float')
  double? get sugarIntakeGFloat => throw _privateConstructorUsedError;
  @JsonKey(name: 'fat_intake_g_float')
  double? get fatIntakeGFloat => throw _privateConstructorUsedError;
  @JsonKey(name: 'trans_fat_intake_g_float')
  double? get transFatIntakeGFloat => throw _privateConstructorUsedError;
  @JsonKey(name: 'carbohydrates_intake_g_float')
  double? get carbohydratesIntakeGFloat => throw _privateConstructorUsedError;
  @JsonKey(name: 'fiber_intake_g_float')
  double? get fiberIntakeGFloat => throw _privateConstructorUsedError;
  @JsonKey(name: 'alcohol_intake_g_float')
  double? get alcoholIntakeGFloat => throw _privateConstructorUsedError;
  @JsonKey(name: 'sodium_intake_mg_float')
  double? get sodiumIntakeMgFloat => throw _privateConstructorUsedError;
  @JsonKey(name: 'cholesterol_intake_mg_float')
  double? get cholesterolIntakeMgFloat => throw _privateConstructorUsedError;
...
class _$NutritionCopyWithImpl<$Res, $Val extends Nutrition>
  ...
  @override
  $Res call({
    Object? foodIntakeFloat = freezed,
    Object? caloriesIntakeKcalFloat = freezed,
    Object? proteinIntakeGFloat = freezed,
    Object? sugarIntakeGFloat = freezed,
    Object? fatIntakeGFloat = freezed,
    Object? transFatIntakeGFloat = freezed,
    Object? carbohydratesIntakeGFloat = freezed,
    Object? fiberIntakeGFloat = freezed,
    Object? alcoholIntakeGFloat = freezed,
...
class _$NutritionImpl implements _Nutrition {
  ...
  @override
  @JsonKey(name: 'sugar_intake_g_float')
  final double? sugarIntakeGFloat;
  @override
  @JsonKey(name: 'fat_intake_g_float')
  final double? fatIntakeGFloat;
  @override
  @JsonKey(name: 'trans_fat_intake_g_float')
  ...
  @override
  @JsonKey(name: 'fiber_intake_g_float')
  final double? fiberIntakeGFloat;
  @override
  @JsonKey(name: 'alcohol_intake_g_float')
  ...
  @override
  String toString() {
    return 'Nutrition(foodIntakeFloat: $foodIntakeFloat, caloriesIntakeKcalFloat: $caloriesIntakeKcalFloat, proteinIntakeGFloat: $proteinIntakeGFloat, sugarIntakeGFloat: $sugarIntakeGFloat, fatIntakeGFloat: $fatIntakeGFloat, transFatIntakeGFloat: $transFatIntakeGFloat, carbohydratesIntakeGFloat: $carbohydratesIntakeGFloat, fiberIntakeGFloat: $fiberIntakeGFloat, alcoholIntakeGFloat: $alcoholIntakeGFloat, sodiumIntakeMgFloat: $sodiumIntakeMgFloat, cholesterolIntakeMgFloat: $cholesterolIntakeMgFloat)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.sugarIntakeGFloat, sugarIntakeGFloat) ||
                other.sugarIntakeGFloat == sugarIntakeGFloat) &&
            (identical(other.fatIntakeGFloat, fatIntakeGFloat) ||
            ...
            (identical(other.alcoholIntakeGFloat, alcoholIntakeGFloat) ||
                other.alcoholIntakeGFloat == alcoholIntakeGFloat) &&
...
abstract class _Nutrition implements Nutrition {
  ...
  @override
  @JsonKey(name: 'food_intake_float')
  double? get foodIntakeFloat;
  @override
  @JsonKey(name: 'calories_intake_kcal_float')
  double? get caloriesIntakeKcalFloat;
  @override
  @JsonKey(name: 'protein_intake_g_float')
  double? get proteinIntakeGFloat;
  @override
  @JsonKey(name: 'sugar_intake_g_float')
  double? get sugarIntakeGFloat;
  @override
  @JsonKey(name: 'fat_intake_g_float')
  double? get fatIntakeGFloat;
  @override
  @JsonKey(name: 'trans_fat_intake_g_float')
  double? get transFatIntakeGFloat;
  @override
  @JsonKey(name: 'carbohydrates_intake_g_float')
  double? get carbohydratesIntakeGFloat;
  @override
  @JsonKey(name: 'fiber_intake_g_float')
  double? get fiberIntakeGFloat;
  @override
  @JsonKey(name: 'alcohol_intake_g_float')
  double? get alcoholIntakeGFloat;
  @override
  @JsonKey(name: 'sodium_intake_mg_float')
  double? get sodiumIntakeMgFloat;
  @override
  @JsonKey(name: 'cholesterol_intake_mg_float')
  double? get cholesterolIntakeMgFloat;
