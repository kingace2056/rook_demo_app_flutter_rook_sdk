...
SleepDurationScore _$SleepDurationScoreFromJson(Map<String, dynamic> json) {
  return _SleepDurationScore.fromJson(json);
}

/// @nodoc
mixin _$SleepDurationScore {
  ...
  /// Serializes this SleepDurationScore to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of SleepDurationScore
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $SleepDurationScoreCopyWith<SleepDurationScore> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $SleepDurationScoreCopyWith<$Res> {
  factory $SleepDurationScoreCopyWith(
          SleepDurationScore value, $Res Function(SleepDurationScore) then) =
      _$SleepDurationScoreCopyWithImpl<$Res, SleepDurationScore>;
  @useResult
  $Res call(
...
/// @nodoc
class _$SleepDurationScoreCopyWithImpl<$Res, $Val extends SleepDurationScore>
    implements $SleepDurationScoreCopyWith<$Res> {
  _$SleepDurationScoreCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$SleepDurationScoreImplCopyWith<$Res>
    implements $SleepDurationScoreCopyWith<$Res> {
  factory _$$SleepDurationScoreImplCopyWith(_$SleepDurationScoreImpl value,
          $Res Function(_$SleepDurationScoreImpl) then) =
      __$$SleepDurationScoreImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: 'datetime_string') DateTime? datetimeString,
...
/// @nodoc
class __$$SleepDurationScoreImplCopyWithImpl<$Res>
    extends _$SleepDurationScoreCopyWithImpl<$Res, _$SleepDurationScoreImpl>
    implements _$$SleepDurationScoreImplCopyWith<$Res> {
  __$$SleepDurationScoreImplCopyWithImpl(_$SleepDurationScoreImpl _value,
      $Res Function(_$SleepDurationScoreImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$SleepDurationScoreImpl(
      datetimeString: freezed == datetimeString
          ? _value.datetimeString
          : datetimeString // ignore: cast_nullable_to_non_nullable
              as DateTime?,
...
/// @nodoc
@JsonSerializable()
class _$SleepDurationScoreImpl implements _SleepDurationScore {
  ...
  factory _$SleepDurationScoreImpl.fromJson(Map<String, dynamic> json) =>
      _$$SleepDurationScoreImplFromJson(json);
  ...
  @override
  String toString() {
    return 'SleepDurationScore(datetimeString: $datetimeString, createdAtString: $createdAtString, updatedAtString: $updatedAtString, score0100Int: $score0100Int, calculatedWithMissingUserInfoBool: $calculatedWithMissingUserInfoBool)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$SleepDurationScoreImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$SleepDurationScoreImplCopyWith<_$SleepDurationScoreImpl> get copyWith =>
      __$$SleepDurationScoreImplCopyWithImpl<_$SleepDurationScoreImpl>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$SleepDurationScoreImplToJson(
      this,
    );
  }
}

abstract class _SleepDurationScore implements SleepDurationScore {
  factory _SleepDurationScore(
  ...
  factory _SleepDurationScore.fromJson(Map<String, dynamic> json) =
      _$SleepDurationScoreImpl.fromJson;
