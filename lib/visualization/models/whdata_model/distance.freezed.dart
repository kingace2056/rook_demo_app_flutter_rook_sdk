    ...
    return _then(_value.copyWith(
      ...
      floorsClimbedFloat: freezed == floorsClimbedFloat
          ...
          : floorsClimbedFloat // ignore: cast_nullable_to_non_nullable
              as int?,
      elevationAvgAltitudeMetersFloat: freezed ==
          ...
          : elevationAvgAltitudeMetersFloat // ignore: cast_nullable_to_non_nullable
              as double?,
      elevationMinimumAltitudeMetersFloat: freezed ==
          ...
          : elevationMinimumAltitudeMetersFloat // ignore: cast_nullable_to_non_nullable
              as double?,
      elevationMaximumAltitudeMetersFloat: freezed ==
          ...
          : elevationMaximumAltitudeMetersFloat // ignore: cast_nullable_to_non_nullable
              as double?,
      elevationLossActualAltitudeMetersFloat: freezed ==
          ...
          : elevationLossActualAltitudeMetersFloat // ignore: cast_nullable_to_non_nullable
              as double?,
      elevationGainActualAltitudeMetersFloat: freezed ==
          ...
          : elevationGainActualAltitudeMetersFloat // ignore: cast_nullable_to_non_nullable
              as double?,
      elevationPlannedGainMetersFloat: freezed ==
      ...
      swimmingPoolLengthMetersFloat: freezed == swimmingPoolLengthMetersFloat
          ...
          : swimmingPoolLengthMetersFloat // ignore: cast_nullable_to_non_nullable
              as double?,
      swimmingTotalDistanceMetersFloat: freezed ==
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.walkedDistanceMetersFloat, walkedDistanceMetersFloat) ||
                other.walkedDistanceMetersFloat == walkedDistanceMetersFloat) &&
            (identical(other.traveledDistanceMetersFloat, traveledDistanceMetersFloat) ||
            ...
            (identical(other.elevationAvgAltitudeMetersFloat, elevationAvgAltitudeMetersFloat) ||
                other.elevationAvgAltitudeMetersFloat ==
                    elevationAvgAltitudeMetersFloat) &&
            (identical(other.elevationMinimumAltitudeMetersFloat, elevationMinimumAltitudeMetersFloat) ||
                other.elevationMinimumAltitudeMetersFloat ==
                    elevationMinimumAltitudeMetersFloat) &&
            (identical(other.elevationMaximumAltitudeMetersFloat, elevationMaximumAltitudeMetersFloat) ||
                other.elevationMaximumAltitudeMetersFloat ==
                    elevationMaximumAltitudeMetersFloat) &&
            (identical(other.elevationLossActualAltitudeMetersFloat, elevationLossActualAltitudeMetersFloat) ||
                other.elevationLossActualAltitudeMetersFloat ==
                    elevationLossActualAltitudeMetersFloat) &&
            (identical(other.elevationGainActualAltitudeMetersFloat, elevationGainActualAltitudeMetersFloat) ||
                other.elevationGainActualAltitudeMetersFloat ==
                    elevationGainActualAltitudeMetersFloat) &&
            (identical(other.elevationPlannedGainMetersFloat, elevationPlannedGainMetersFloat) ||
                other.elevationPlannedGainMetersFloat ==
                    elevationPlannedGainMetersFloat) &&
            (identical(other.swimmingNumStrokesFloat, swimmingNumStrokesFloat) ||
            ...
            (identical(other.swimmingPoolLengthMetersFloat, swimmingPoolLengthMetersFloat) ||
                other.swimmingPoolLengthMetersFloat ==
                    swimmingPoolLengthMetersFloat) &&
            (identical(other.swimmingTotalDistanceMetersFloat, swimmingTotalDistanceMetersFloat) ||
                other.swimmingTotalDistanceMetersFloat ==
                    swimmingTotalDistanceMetersFloat) &&
            (identical(other.activeStepsInt, activeStepsInt) || other.activeStepsInt == activeStepsInt) &&
            const DeepCollectionEquality().equals(other._activeStepsGranularDataArray, _activeStepsGranularDataArray));
  }
...
abstract class _Distance implements Distance {
  factory _Distance(
      ...
      final List<ActiveStepsGranularDataArray>?
          activeStepsGranularDataArray}) = _$DistanceImpl;
