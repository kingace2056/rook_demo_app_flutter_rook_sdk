...
/// @nodoc
mixin _$NonStructuredDataArray {
  @JsonKey(name: 'source_of_data_string')
  String? get sourceOfDataString => throw _privateConstructorUsedError;
  @JsonKey(name: 'time_zone')
  String? get timeZone => throw _privateConstructorUsedError;
  @JsonKey(name: 'offset_time_zone')
  int? get offsetTimeZone => throw _privateConstructorUsedError;
  @JsonKey(name: 'uuid_device')
  String? get uuidDevice => throw _privateConstructorUsedError;
  @JsonKey(name: 'walking_speed')
  int? get walkingSpeed => throw _privateConstructorUsedError;
  @JsonKey(name: 'walking_step_length')
  int? get walkingStepLength => throw _privateConstructorUsedError;

  /// Serializes this NonStructuredDataArray to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of NonStructuredDataArray
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $NonStructuredDataArrayCopyWith<NonStructuredDataArray> get copyWith =>
...
>
  ...
  $Res call({
    ...
    Object? offsetTimeZone = freezed,
    Object? uuidDevice = freezed,
...
class _$NonStructuredDataArrayImpl implements _NonStructuredDataArray {
  ...
  @override
  @JsonKey(name: 'walking_step_length')
  final int? walkingStepLength;

  @override
  String toString() {
    return 'NonStructuredDataArray(sourceOfDataString: $sourceOfDataString, timeZone: $timeZone, offsetTimeZone: $offsetTimeZone, uuidDevice: $uuidDevice, walkingSpeed: $walkingSpeed, walkingStepLength: $walkingStepLength)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$NonStructuredDataArrayImpl &&
            (identical(other.sourceOfDataString, sourceOfDataString) ||
                other.sourceOfDataString == sourceOfDataString) &&
            (identical(other.timeZone, timeZone) ||
                other.timeZone == timeZone) &&
            (identical(other.offsetTimeZone, offsetTimeZone) ||
                other.offsetTimeZone == offsetTimeZone) &&
            (identical(other.uuidDevice, uuidDevice) ||
                other.uuidDevice == uuidDevice) &&
            (identical(other.walkingSpeed, walkingSpeed) ||
                other.walkingSpeed == walkingSpeed) &&
            (identical(other.walkingStepLength, walkingStepLength) ||
                other.walkingStepLength == walkingStepLength));
  }
...
abstract class _NonStructuredDataArray implements NonStructuredDataArray {
  ...
  @override
  @JsonKey(name: 'offset_time_zone')
  int? get offsetTimeZone;
  @override
  @JsonKey(name: 'uuid_device')
  String? get uuidDevice;
  @override
  @JsonKey(name: 'walking_speed')
  int? get walkingSpeed;
  @override
  @JsonKey(name: 'walking_step_length')
  int? get walkingStepLength;
