...
_$HeartRateEventImpl _$$HeartRateEventImplFromJson(
  ...
  eventData: json['event_data'] == null
      ? null
      : HeartRateEventData.fromJson(json['event_data'] as Map<String, dynamic>),
  metadata: json['metadata'] == null
      ? null
      : HeartRateMetadata.fromJson(json['metadata'] as Map<String, dynamic>),
...
_$HeartRateEventDetailImpl _$$HeartRateEventDetailImplFromJson(
  ...
  nonStructuredDataArray: (json['non_structured_data_array'] as List<dynamic>?)
...
_$HeartRateGranularDataImpl _$$HeartRateGranularDataImplFromJson(
  ...
  intervalDurationSeconds: (json['interval_duration_seconds_float'] as num?)
      ?.toDouble(),
...
) => <String, dynamic>{'source_of_data_string': instance.sourceOfData};
