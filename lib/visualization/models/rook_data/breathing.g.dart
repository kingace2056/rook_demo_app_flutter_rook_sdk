...
_$BreathingImpl _$$BreathingImplFromJson(Map<String, dynamic> json) =>
    _$BreathingImpl(
      breathsMinimumPerMinInt: (json['breaths_minimum_per_min_int'] as num?)
          ?.toInt(),
      breathsAvgPerMinInt: (json['breaths_avg_per_min_int'] as num?)?.toInt(),
      breathsMaximumPerMinInt: (json['breaths_maximum_per_min_int'] as num?)
          ?.toInt(),
      snoringEventsCountInt: (json['snoring_events_count_int'] as num?)
          ?.toInt(),
...
Map<String, dynamic> _$$BreathingImplToJson(
  _$BreathingImpl instance,
) => <String, dynamic>{
  ...
  'snoring_duration_total_seconds_int': instance.snoringDurationTotalSecondsInt,
  'saturation_avg_percentage_int': instance.saturationAvgPercentageInt,
  'saturation_minimum_percentage_int': instance.saturationMinimumPercentageInt,
  'saturation_maximum_percentage_int': instance.saturationMaximumPercentageInt,
};
